...
class TestMediaConverter:
    ...
    def test_convert_single_file_success(self, mock_input):
        ...
        result = convert_single_file_functional(self.test_file, "mp3", self.temp_dir)
    ...
    def test_convert_single_file_invalid_format(self, mock_input):
        ...
        result = convert_single_file_functional(self.test_file, "invalid_format", self.temp_dir)
    ...
    def test_convert_files(self, mock_resolve_dir, mock_convert_single):
        ...
        mock_convert_single.return_value = {"success": True, "input_file": str(self.test_file), "output_file": "output.mp3", "format": "mp3"}
        
        files = [self.test_file]
        result = convert_files_functional(files, "mp3", str(self.temp_dir))
    ...
    def test_convert_main_function_success(self, mock_convert_files, mock_get_files):
        ...
        mock_convert_files.return_value = [{"success": True}]
